    ...
    "./src/button/index.js": function(module, __webpack_exports__, __webpack_require__) {
        ...
        var checkout = {
                    ...
                    return (instance = Checkout({
                        ...
                        dimensions: function() {
                            if (Object.values(APM_LIST).includes(fundingSource)) {
                                logger_getLogger().info("dimensions_apmlist_fundingsource_" + fundingSource).flush();
                                return {
                                    width: 1280,
                                    height: 768
                                };
                    ...
                    click: function() {
                        return promise_ZalgoPromise.try((function() {
                            if (!win && supportsPopups()) try {
                                var _ref9 = function() {
                                    return Object.values(APM_LIST).includes(fundingSource) ? {
                                        width: 1280,
                                        height: 768
                                    } : {
                                        width: 500,
            ...
            updateFlowClientConfig: function(_ref10) {
                var orderID = _ref10.orderID, payment = _ref10.payment, userExperienceFlow = _ref10.userExperienceFlow;
                return promise_ZalgoPromise.try((function() {
